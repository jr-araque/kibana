...
import type { BulkCreateExceptionListItemsRequestBodyInput } from '@kbn/securitysolution-exceptions-common/api/bulk_create_exception_list_items/bulk_create_exception_list_items.gen';
...
const securitySolutionApiServiceFactory = (supertest: SuperTest.Agent) => ({
   ...
   */
  bulkCreateExceptionListItems(
    props: BulkCreateExceptionListItemsProps,
    kibanaSpace: string = 'default'
  ) {
    return supertest
      .post(getRouteUrlForSpace('/api/exception_lists/items/_bulk', kibanaSpace))
      .set('kbn-xsrf', 'true')
